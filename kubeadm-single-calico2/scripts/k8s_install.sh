...
echo "192.168.56.16 $(hostname)" >> /etc/hosts
...
kubeadm init --control-plane-endpoint=$controlplane --apiserver-advertise-address "192.168.56.18" --pod-network-cidr "100.64.0.0/16"  --service-cidr "100.65.0.0/16" #--skip-phases=addon/kube-proxy
